...
large number of half-open connections(半開放的連線). What best describes this attack?
A. DDoS
## B. SYN flood
C. Buffer overflow
D. ARP poisoning
...
D. Macro virus
# 10
10. Your company(公司) outsourced(外包) development of an accounting(會計) application to a local programming
firm. After three months of using the product, one of your accountants accidently(偶然的)
